...
from LoadEnviroment.LoadEnv import aegis_id_json_path, sec_ch_ua, user_agent, \
    filetransfer_baseurl, aegis_report_id
...
def get_header(host, content_type=None, referer=filetransfer_baseurl, origin=filetransfer_baseurl):
    header = {
        "Accept": "*/*",
